...
template: splash
hero:
  tagline: Turn your Discord forums into powerful APIs for FAQs, blogs, knowledge bases, and more.
  image:
...
Built with by [Kevin Trinh](https://github.com/KevinTrinh1227) and contributors.
