...
template: splash
hero:
  tagline: Transform your Discord forums into powerful APIs for FAQs, blogs, knowledge bases, and more.
  image:
  ...
  actions:
    - text: Get Started
      ...
      variant: primary
    - text: View on GitHub
      link: https://github.com/KevinTrinh1227/discord-forum-api
      icon: external
---
...
- [GitHub Repository](https://github.com/KevinTrinh1227/discord-forum-api)
- [Report Issues](https://github.com/KevinTrinh1227/discord-forum-api/issues)
- [Discussions](https://github.com/KevinTrinh1227/discord-forum-api/discussions)

---

<Aside type="caution" title="Disclaimer">
  This project is **not affiliated with, endorsed by, or connected to Discord Inc.** "Discord" is a trademark of Discord Inc. Threadlink is an independent, open-source project.
</Aside>

Built with ❤️ by [Kevin Trinh](https://github.com/KevinTrinh1227) and contributors.
