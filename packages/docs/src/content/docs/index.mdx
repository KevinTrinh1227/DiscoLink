...
hero:
  ...
  actions:
    - text: Get Started
      ...
      variant: primary
    - text: View on GitHub
      link: https://github.com/KevinTrinh1227/discolink
      icon: external
---
...
- [GitHub Repository](https://github.com/KevinTrinh1227/discolink)
- [Report Issues](https://github.com/KevinTrinh1227/discolink/issues)
- [Discussions](https://github.com/KevinTrinh1227/discolink/discussions)

---

<Aside type="caution" title="Disclaimer">
  This project is **not affiliated with, endorsed by, or connected to Discord Inc.** "Discord" is a trademark of Discord Inc. DiscoLink is an independent, open-source project.
</Aside>
