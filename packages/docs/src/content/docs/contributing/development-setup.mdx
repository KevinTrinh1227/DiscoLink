...
pnpm --filter @discord-forum-api/bot build
pnpm --filter @discord-forum-api/db test
```
...
```bash
# By package
pnpm --filter @discord-forum-api/api test
...
```bash
pnpm --filter @discord-forum-api/db tsx src/seed.ts
```
  ...
  "configurations": [
    {
      ...
      "runtimeArgs": ["--filter", "@discord-forum-api/api", "dev"],
      "cwd": "${workspaceFolder}",
    ...
    },
    {
      ...
      "request": "launch",
      "runtimeExecutable": "pnpm",
      "runtimeArgs": ["--filter", "@discord-forum-api/bot", "dev"],
      "cwd": "${workspaceFolder}",
      "console": "integratedTerminal"
    }
  ]
